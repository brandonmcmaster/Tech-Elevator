...
namespace Exercises
{
    public class Exercise03_Shirts
    {
        ...
        */
        ...
        {
            return new char[] { SmallShirt, SmallShirt, SmallShirt, MediumShirt, MediumShirt, LargeShirt };
        }
        ...
        public char[] BuildBulkOrder(int numberOfShirts)
        {
           char[] bulkOrder = new char[numberOfShirts];
            ...
            for ( int i = 0; i < numberOfShirts; i++)
            {
                if (i % 3 == 0 )
                {
                    bulkOrder[i] = SmallShirt;
                }
                else if (i % 3 == 1)
                {
                    bulkOrder[i] = MediumShirt;
                }
                else if (i % 3 == 2)
                {
                    bulkOrder[i] = LargeShirt;
                }
