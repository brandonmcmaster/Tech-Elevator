...
namespace Lecture.Tests
{
    ...
    public class ValidationTests
    {
        ...
        {
            Assert.AreEqual(9.99, exercises.ReturnPizzaCost('s', 1), 0.001);
            Assert.AreEqual(10.99, exercises.ReturnPizzaCost('m', 1), 0.001);
            Assert.AreEqual(11.99, exercises.ReturnPizzaCost('s', 3), 0.001);
            Assert.AreEqual(10.99, exercises.ReturnPizzaCost('l', 0), 0.001);
            Assert.AreEqual(13.99, exercises.ReturnPizzaCost('l', 4), 0.001);
        }
    }
}
